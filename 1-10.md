...
```
[[ $(php -v) ]] || apt update && apt install lsb-release apt-transport-https ca-certificates wget -y && \
...
[[ $(ls /usr/bin/composer) ]] || wget https://getcomposer.org/download/2.0.13/composer.phar -O /root/composer.phar && \
