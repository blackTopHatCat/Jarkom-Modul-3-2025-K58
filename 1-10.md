...
```
root@Erendis:~# dig @192.240.3.3 -x ns1.k58.com

; <<>> DiG 9.20.15-1~deb13u1-Debian <<>> @192.240.3.3 -x ns1.k58.com
; (1 server found)
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: SERVFAIL, id: 31696
;; flags: qr rd ra; QUERY: 1, ANSWER: 0, AUTHORITY: 0, ADDITIONAL: 1

;; OPT PSEUDOSECTION:
; EDNS: version: 0, flags:; udp: 1232
; COOKIE: cf79595515eb43950100000069041f11b711e3d16ee15e4b (good)
;; QUESTION SECTION:
;com.k58.ns1.in-addr.arpa.      IN      PTR

;; Query time: 514 msec
;; SERVER: 192.240.3.3#53(192.240.3.3) (UDP)
;; WHEN: Fri Oct 31 02:29:37 UTC 2025
;; MSG SIZE  rcvd: 81
```
